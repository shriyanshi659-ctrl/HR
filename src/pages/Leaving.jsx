...
const Leaving = () => {
  ...
  const fetchJoiningData = async () => {
    ...
    try {
      const response = await fetch(
        'https://script.google.com/macros/s/AKfycbyBRPg5wM0ykxfwKX9j5XjZluuA1h8Sdz5VNqsNZrWyd69pklcH7TyZuF_HwNceHYs/exec?sheet=JOINING&action=fetch'
      );
  ...
  const fetchLeavingData = async () => {
    ...
    try {
      const response = await fetch(
        'https://script.google.com/macros/s/AKfycbyBRPg5wM0ykxfwKX9j5XjZluuA1h8Sdz5VNqsNZrWyd69pklcH7TyZuF_HwNceHYs/exec?sheet=LEAVING&action=fetch'
      );
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      const response = await fetch('https://script.google.com/macros/s/AKfycbyBRPg5wM0ykxfwKX9j5XjZluuA1h8Sdz5VNqsNZrWyd69pklcH7TyZuF_HwNceHYs/exec', {
        method: 'POST',
